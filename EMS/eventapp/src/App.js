...
function App() {
    ...
    const renderHeader=()=>{
        ...
        if(userRole==='Organiser')
            return <OrgHeader userRole={userRole} setUserRole={setUserRole}/>
        else if(userRole==='Attendee')
            return <AttendeeHeader userRole={userRole} setUserRole={setUserRole}/>
        else if(userRole==='default')
            return <Header/>
    }
    const renderUserPage=()=>{
        if(userRole==='Organiser')
            return <OrgHome email={email}/>
        else if(userRole==='Attendee')
            return <AttendeeHome email={email}/>
        else
            return <Home/>
    }
        ...
        <Router>
          ...
          <div className="Container">
            <Switch>
              ...
              <Route path="/UserHome" render={()=>renderUserPage()}></Route>
